...
pub type EXTIME_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2_TIMING_SPEC, u8, u8, 6, O>;
...
pub type SAMPLEDLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2_TIMING_SPEC, u8, u8, 8, O>;
...
pub type MEASUREDLY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH2_TIMING_SPEC, u16, u16, 10, O>;
impl R {
