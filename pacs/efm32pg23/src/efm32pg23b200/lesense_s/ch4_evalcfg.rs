#[doc = "Register `CH4_EVALCFG` reader"]
pub struct R(crate::R<CH4_EVALCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH4_EVALCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH4_EVALCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH4_EVALCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH4_EVALCFG` writer"]
pub struct W(crate::W<CH4_EVALCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH4_EVALCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH4_EVALCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH4_EVALCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DECODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH4_EVALCFG_SPEC, bool, O>;
...
pub type COMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH4_EVALCFG_SPEC, COMP_A, O>;
...
pub type STRSAMPLE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH4_EVALCFG_SPEC, u8, STRSAMPLE_A, 2, O>;
...
pub type SCANRESINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH4_EVALCFG_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH4_EVALCFG_SPEC, u8, MODE_A, 2, O>;
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch4_evalcfg](index.html) module"]
pub struct CH4_EVALCFG_SPEC;
impl crate::RegisterSpec for CH4_EVALCFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch4_evalcfg::R](R) reader structure"]
impl crate::Readable for CH4_EVALCFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch4_evalcfg::W](W) writer structure"]
impl crate::Writable for CH4_EVALCFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH4_EVALCFG to value 0"]
impl crate::Resettable for CH4_EVALCFG_SPEC {
