...
pub struct R(crate::R<CH13_TIMING_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH13_TIMING_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH13_TIMING_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH13_TIMING_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH13_TIMING` writer"]
pub struct W(crate::W<CH13_TIMING_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH13_TIMING_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH13_TIMING_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH13_TIMING_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXTIME_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH13_TIMING_SPEC, u8, u8, 6, O>;
...
pub type SAMPLEDLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH13_TIMING_SPEC, u8, u8, 8, O>;
...
pub type MEASUREDLY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH13_TIMING_SPEC, u16, u16, 10, O>;
impl R {
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch13_timing](index.html) module"]
pub struct CH13_TIMING_SPEC;
impl crate::RegisterSpec for CH13_TIMING_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch13_timing::R](R) reader structure"]
impl crate::Readable for CH13_TIMING_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch13_timing::W](W) writer structure"]
impl crate::Writable for CH13_TIMING_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH13_TIMING to value 0"]
impl crate::Resettable for CH13_TIMING_SPEC {
