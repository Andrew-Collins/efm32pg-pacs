...
pub type SCOMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST18_ARC_SPEC, u8, u8, 4, O>;
#[doc = "Field `SMASK` reader - Sensor mask"]
pub type SMASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SMASK` writer - Sensor mask"]
pub type SMASK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST18_ARC_SPEC, u8, u8, 4, O>;
...
pub type CURSTATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST18_ARC_SPEC, u8, u8, 5, O>;
...
pub type PRSACT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST18_ARC_SPEC, u8, PRSACT_A, 3, O>;
...
pub type NEXTSTATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST18_ARC_SPEC, u8, u8, 5, O>;
#[doc = "Field `SETIF` reader - Set interrupt flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set interrupt flag"]
pub type SETIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ST18_ARC_SPEC, bool, O>;
impl R {
