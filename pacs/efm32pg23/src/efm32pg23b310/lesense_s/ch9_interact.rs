...
pub struct R(crate::R<CH9_INTERACT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH9_INTERACT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH9_INTERACT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH9_INTERACT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH9_INTERACT` writer"]
pub struct W(crate::W<CH9_INTERACT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH9_INTERACT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH9_INTERACT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH9_INTERACT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type THRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH9_INTERACT_SPEC, u16, u16, 12, O>;
...
pub type EXMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH9_INTERACT_SPEC, u8, EXMODE_A, 2, O>;
...
pub type ALTEX_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH9_INTERACT_SPEC, bool, O>;
...
pub type SAMPLECLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CH9_INTERACT_SPEC, SAMPLECLK_A, O>;
...
pub type EXCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH9_INTERACT_SPEC, EXCLK_A, O>;
...
pub type SETIF_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH9_INTERACT_SPEC, u8, SETIF_A, 3, O>;
...
pub type OFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH9_INTERACT_SPEC, u8, u8, 4, O>;
...
pub type SAMPLE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH9_INTERACT_SPEC, u8, SAMPLE_A, 2, O>;
...
pub struct CH9_INTERACT_SPEC;
impl crate::RegisterSpec for CH9_INTERACT_SPEC {
    type Ux = u32;
}
