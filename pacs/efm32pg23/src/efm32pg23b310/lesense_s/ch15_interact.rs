...
pub type THRES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH15_INTERACT_SPEC, u16, u16, 12, O>;
...
pub type EXMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH15_INTERACT_SPEC, u8, EXMODE_A, 2, O>;
...
pub type ALTEX_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH15_INTERACT_SPEC, bool, O>;
...
pub type SETIF_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH15_INTERACT_SPEC, u8, SETIF_A, 3, O>;
...
pub type OFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH15_INTERACT_SPEC, u8, u8, 4, O>;
...
pub type SAMPLE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH15_INTERACT_SPEC, u8, SAMPLE_A, 2, O>;
