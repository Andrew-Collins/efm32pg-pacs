...
pub type AUXSTARTUP_R = crate::BitReader<AUXSTARTUP_A>;
#[doc = "AUX startup config\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AUXSTARTUP_A {
    #[doc = "0: Request oscillator .5 LESENSECLK cycle before sensing starts"]
    PREDEMAND = 0,
    #[doc = "1: Request oscillator at sensing time"]
    ONDEMAND = 1,
}
impl From<AUXSTARTUP_A> for bool {
    #[inline(always)]
    fn from(variant: AUXSTARTUP_A) -> Self {
        variant as u8 != 0
    }
}
impl AUXSTARTUP_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> AUXSTARTUP_A {
        match self.bits {
            false => AUXSTARTUP_A::PREDEMAND,
            true => AUXSTARTUP_A::ONDEMAND,
        }
    }
    #[doc = "Checks if the value of the field is `PREDEMAND`"]
    #[inline(always)]
    pub fn is_predemand(&self) -> bool {
        *self == AUXSTARTUP_A::PREDEMAND
    }
    #[doc = "Checks if the value of the field is `ONDEMAND`"]
    #[inline(always)]
    pub fn is_ondemand(&self) -> bool {
        *self == AUXSTARTUP_A::ONDEMAND
    }
}
#[doc = "Field `AUXSTARTUP` writer - AUX startup config"]
pub type AUXSTARTUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCTRL_SPEC, AUXSTARTUP_A, O>;
impl<'a, const O: u8> AUXSTARTUP_W<'a, O> {
    #[doc = "Request oscillator .5 LESENSECLK cycle before sensing starts"]
    #[inline(always)]
    pub fn predemand(self) -> &'a mut W {
        self.variant(AUXSTARTUP_A::PREDEMAND)
    }
    #[doc = "Request oscillator at sensing time"]
    #[inline(always)]
    pub fn ondemand(self) -> &'a mut W {
        self.variant(AUXSTARTUP_A::ONDEMAND)
    }
}
impl R {
