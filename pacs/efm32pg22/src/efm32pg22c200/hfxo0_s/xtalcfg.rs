...
impl TIMEOUTSTEADY_R {
    ...
    pub fn variant(&self) -> TIMEOUTSTEADY_A {
        match self.bits {
            0 => TIMEOUTSTEADY_A::T16US,
            1 => TIMEOUTSTEADY_A::T41US,
            2 => TIMEOUTSTEADY_A::T83US,
            3 => TIMEOUTSTEADY_A::T125US,
            4 => TIMEOUTSTEADY_A::T166US,
            5 => TIMEOUTSTEADY_A::T208US,
            6 => TIMEOUTSTEADY_A::T250US,
            7 => TIMEOUTSTEADY_A::T333US,
            8 => TIMEOUTSTEADY_A::T416US,
            9 => TIMEOUTSTEADY_A::T500US,
            10 => TIMEOUTSTEADY_A::T666US,
            11 => TIMEOUTSTEADY_A::T833US,
            12 => TIMEOUTSTEADY_A::T1666US,
            13 => TIMEOUTSTEADY_A::T2500US,
            14 => TIMEOUTSTEADY_A::T4166US,
            15 => TIMEOUTSTEADY_A::T7500US,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `T7500US`"]
    #[inline(always)]
    pub fn is_t7500us(&self) -> bool {
        *self == TIMEOUTSTEADY_A::T7500US
    }
}
