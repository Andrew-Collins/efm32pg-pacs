...
pub struct R(crate::R<ASYNC_CH1_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ASYNC_CH1_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ASYNC_CH1_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ASYNC_CH1_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNC_CH1_CTRL` writer"]
pub struct W(crate::W<ASYNC_CH1_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ASYNC_CH1_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ASYNC_CH1_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ASYNC_CH1_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIGSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASYNC_CH1_CTRL_SPEC, u8, SIGSEL_A, 3, O>;
...
pub type SOURCESEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASYNC_CH1_CTRL_SPEC, u8, u8, 7, O>;
...
pub type FNSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, ASYNC_CH1_CTRL_SPEC, u8, FNSEL_A, 4, O>;
...
pub type AUXSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ASYNC_CH1_CTRL_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [async_ch1_ctrl](index.html) module"]
pub struct ASYNC_CH1_CTRL_SPEC;
impl crate::RegisterSpec for ASYNC_CH1_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [async_ch1_ctrl::R](R) reader structure"]
impl crate::Readable for ASYNC_CH1_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [async_ch1_ctrl::W](W) writer structure"]
impl crate::Writable for ASYNC_CH1_CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ASYNC_CH1_CTRL to value 0x000c_0000"]
impl crate::Resettable for ASYNC_CH1_CTRL_SPEC {
