...
pub type SIGSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASYNC_CH6_CTRL_SPEC, u8, SIGSEL_A, 3, O>;
...
pub type SOURCESEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASYNC_CH6_CTRL_SPEC, u8, u8, 7, O>;
...
pub type FNSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, ASYNC_CH6_CTRL_SPEC, u8, FNSEL_A, 4, O>;
...
pub type AUXSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ASYNC_CH6_CTRL_SPEC, u8, u8, 4, O>;
impl R {
