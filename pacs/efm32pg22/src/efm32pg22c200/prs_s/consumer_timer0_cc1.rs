...
pub struct R(crate::R<CONSUMER_TIMER0_CC1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONSUMER_TIMER0_CC1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONSUMER_TIMER0_CC1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONSUMER_TIMER0_CC1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONSUMER_TIMER0_CC1` writer"]
pub struct W(crate::W<CONSUMER_TIMER0_CC1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONSUMER_TIMER0_CC1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONSUMER_TIMER0_CC1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONSUMER_TIMER0_CC1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRSSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONSUMER_TIMER0_CC1_SPEC, u8, u8, 4, O>;
...
pub type SPRSSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONSUMER_TIMER0_CC1_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "CC1 Consumer Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [consumer_timer0_cc1](index.html) module"]
pub struct CONSUMER_TIMER0_CC1_SPEC;
impl crate::RegisterSpec for CONSUMER_TIMER0_CC1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [consumer_timer0_cc1::R](R) reader structure"]
impl crate::Readable for CONSUMER_TIMER0_CC1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [consumer_timer0_cc1::W](W) writer structure"]
impl crate::Writable for CONSUMER_TIMER0_CC1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CONSUMER_TIMER0_CC1 to value 0"]
impl crate::Resettable for CONSUMER_TIMER0_CC1_SPEC {
