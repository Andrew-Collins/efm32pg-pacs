...
pub struct R(crate::R<CONSUMER_TIMER4_CC1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONSUMER_TIMER4_CC1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONSUMER_TIMER4_CC1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONSUMER_TIMER4_CC1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONSUMER_TIMER4_CC1` writer"]
pub struct W(crate::W<CONSUMER_TIMER4_CC1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONSUMER_TIMER4_CC1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONSUMER_TIMER4_CC1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONSUMER_TIMER4_CC1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CC1 Consumer Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [consumer_timer4_cc1](index.html) module"]
pub struct CONSUMER_TIMER4_CC1_SPEC;
impl crate::RegisterSpec for CONSUMER_TIMER4_CC1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [consumer_timer4_cc1::R](R) reader structure"]
impl crate::Readable for CONSUMER_TIMER4_CC1_SPEC {
    type Reader = R;
}
