...
pub struct R(crate::R<PORTA_MODEH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PORTA_MODEH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PORTA_MODEH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PORTA_MODEH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PORTA_MODEH` writer"]
pub struct W(crate::W<PORTA_MODEH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PORTA_MODEH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PORTA_MODEH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PORTA_MODEH_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "mode high\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [porta_modeh](index.html) module"]
pub struct PORTA_MODEH_SPEC;
impl crate::RegisterSpec for PORTA_MODEH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [porta_modeh::R](R) reader structure"]
impl crate::Readable for PORTA_MODEH_SPEC {
    type Reader = R;
}
