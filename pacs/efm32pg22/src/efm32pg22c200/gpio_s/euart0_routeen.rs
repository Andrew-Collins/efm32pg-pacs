...
pub type RTSPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EUART0_ROUTEEN_SPEC, bool, O>;
...
pub type TXPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EUART0_ROUTEEN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtspen(&mut self) -> RTSPEN_W<0> {
        RTSPEN_W::new(self)
    }
    #[doc = "Bit 1 - TX pin enable control bit"]
    #[inline(always)]
