...
pub struct R(crate::R<SCAN3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCAN3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCAN3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCAN3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCAN3` writer"]
pub struct W(crate::W<SCAN3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCAN3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCAN3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCAN3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [scan3](index.html) module"]
pub struct SCAN3_SPEC;
impl crate::RegisterSpec for SCAN3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [scan3::R](R) reader structure"]
impl crate::Readable for SCAN3_SPEC {
    type Reader = R;
}
