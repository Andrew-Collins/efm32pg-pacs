...
pub type ALIGNMENT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCANFIFOCFG_SPEC, u8, ALIGNMENT_A, 3, O>;
...
pub type SHOWID_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCANFIFOCFG_SPEC, bool, O>;
...
pub type DVL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SCANFIFOCFG_SPEC, u8, DVL_A, 2, O>;
...
pub type DMAWUFIFOSCAN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SCANFIFOCFG_SPEC, DMAWUFIFOSCAN_A, O>;
impl<'a, const O: u8> DMAWUFIFOSCAN_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmawufifoscan(&mut self) -> DMAWUFIFOSCAN_W<8> {
