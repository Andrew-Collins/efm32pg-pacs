...
pub type RAMECCEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMEM0ECCCTRL_SPEC, bool, O>;
...
pub type RAMECCEWEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMEM0ECCCTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rameccen(&mut self) -> RAMECCEN_W<0> {
        RAMECCEN_W::new(self)
    }
    #[doc = "Bit 1 - RAM ECC Error Writeback Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rameccewen(&mut self) -> RAMECCEWEN_W<1> {
