...
pub type ROOTMODELOCK_R = crate::BitReader<bool>;
...
impl R {
    ...
    pub fn rootmodelock(&self) -> ROOTMODELOCK_R {
        ROOTMODELOCK_R::new(((self.bits >> 4) & 1) != 0)
    }
