...
pub type TXFIW_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CFG1_SPEC, u8, TXFIW_A, 2, O>;
...
pub type RXFIW_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CFG1_SPEC, u8, RXFIW_A, 2, O>;
...
pub type RTSRXFW_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CFG1_SPEC, u8, RTSRXFW_A, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxfiw(&mut self) -> RXFIW_W<19> {
        RXFIW_W::new(self)
    }
    #[doc = "Bits 22:23 - Request-to-send RX FIFO Watermark"]
    #[inline(always)]
