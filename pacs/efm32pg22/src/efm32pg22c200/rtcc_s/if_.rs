...
pub type CNTTICK_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnttick(&mut self) -> CNTTICK_W<1> {
        CNTTICK_W::new(self)
    }
    #[doc = "Bit 4 - CC Channel n Interrupt Flag"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1(&mut self) -> CC1_W<6> {
        CC1_W::new(self)
    }
    #[doc = "Bit 8 - CC Channel n Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn cc2(&mut self) -> CC2_W<8> {
        CC2_W::new(self)
    }
