...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC0_CTRL_SPEC, u8, MODE_A, 2, O>;
...
pub type COMPBASE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CTRL_SPEC, COMPBASE_A, O>;
