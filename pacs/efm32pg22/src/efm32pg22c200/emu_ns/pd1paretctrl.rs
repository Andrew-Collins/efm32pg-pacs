...
impl PD1PARETDIS_R {
    ...
    pub fn variant(&self) -> Option<PD1PARETDIS_A> {
        match self.bits {
            0 => Some(PD1PARETDIS_A::RETAIN),
            1 => Some(PD1PARETDIS_A::NORETAIN),
            _ => None,
        }
    }
    ...
    pub fn is_retain(&self) -> bool {
        *self == PD1PARETDIS_A::RETAIN
    }
    #[doc = "Checks if the value of the field is `NORETAIN`"]
    #[inline(always)]
    pub fn is_noretain(&self) -> bool {
        *self == PD1PARETDIS_A::NORETAIN
    }
}
...
impl<'a, const O: u8> PD1PARETDIS_W<'a, O> {
    ...
    pub fn retain(self) -> &'a mut W {
        self.variant(PD1PARETDIS_A::RETAIN)
    }
    #[doc = "Do not retain associcated registers when in EM2/3"]
    #[inline(always)]
    pub fn noretain(self) -> &'a mut W {
        self.variant(PD1PARETDIS_A::NORETAIN)
    }
}
impl R {
