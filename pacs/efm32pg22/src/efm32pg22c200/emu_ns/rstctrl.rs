...
pub type DCIRMODE_R = crate::BitReader<DCIRMODE_A>;
...
impl From<DCIRMODE_A> for bool {
    #[inline(always)]
    fn from(variant: DCIRMODE_A) -> Self {
        variant as u8 != 0
    }
}
impl DCIRMODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DCIRMODE_A {
        match self.bits {
            false => DCIRMODE_A::DISABLED,
            true => DCIRMODE_A::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == DCIRMODE_A::DISABLED
    }
    #[doc = "Checks if the value of the field is `ENABLED`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == DCIRMODE_A::ENABLED
    }
}
#[doc = "Field `DCIRMODE` writer - DCI System reset"]
pub type DCIRMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTCTRL_SPEC, DCIRMODE_A, O>;
impl<'a, const O: u8> DCIRMODE_W<'a, O> {
    #[doc = "Reset request blocked"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(DCIRMODE_A::DISABLED)
    }
    #[doc = "The entire device is reset except some EMU registers"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(DCIRMODE_A::ENABLED)
    }
}
impl R {
    ...
    pub fn dcirmode(&self) -> DCIRMODE_R {
        DCIRMODE_R::new(((self.bits >> 16) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable WDOG0 reset"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcirmode(&mut self) -> DCIRMODE_W<16> {
        DCIRMODE_W::new(self)
    }
...
impl crate::Resettable for RSTCTRL_SPEC {
    const RESET_VALUE: Self::Ux = 0x4001_0407;
}
