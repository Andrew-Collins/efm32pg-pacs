...
pub type USART1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKEN0_SPEC, bool, O>;
...
pub type EUART0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKEN0_SPEC, bool, O>;
#[doc = "Field `PDM` reader - Enable Bus Clock"]
pub type PDM_R = crate::BitReader<bool>;
#[doc = "Field `PDM` writer - Enable Bus Clock"]
pub type PDM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKEN0_SPEC, bool, O>;
...
pub type RTCC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKEN0_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hfxo0(&mut self) -> HFXO0_W<19> {
        HFXO0_W::new(self)
    }
    #[doc = "Bit 20 - Enable Bus Clock"]
    #[inline(always)]
    #[must_use]
    pub fn fsrco(&mut self) -> FSRCO_W<20> {
        FSRCO_W::new(self)
    }
    #[doc = "Bit 21 - Enable Bus Clock"]
    #[inline(always)]
    #[must_use]
    pub fn lfrco(&mut self) -> LFRCO_W<21> {
        LFRCO_W::new(self)
    }
    #[doc = "Bit 22 - Enable Bus Clock"]
    #[inline(always)]
    #[must_use]
    pub fn lfxo(&mut self) -> LFXO_W<22> {
        LFXO_W::new(self)
    }
    #[doc = "Bit 23 - Enable Bus Clock"]
    #[inline(always)]
    #[must_use]
    pub fn ulfrco(&mut self) -> ULFRCO_W<23> {
        ULFRCO_W::new(self)
    }
    #[doc = "Bit 24 - Enable Bus Clock"]
    #[inline(always)]
    #[must_use]
    pub fn euart0(&mut self) -> EUART0_W<24> {
        EUART0_W::new(self)
    }
    #[doc = "Bit 25 - Enable Bus Clock"]
    #[inline(always)]
    #[must_use]
    pub fn pdm(&mut self) -> PDM_W<25> {
        PDM_W::new(self)
    }
    #[doc = "Bit 26 - Enable Bus Clock"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtcc(&mut self) -> RTCC_W<30> {
        RTCC_W::new(self)
    }
    #[doc = "Bit 31 - Enable Bus Clock"]
    #[inline(always)]
