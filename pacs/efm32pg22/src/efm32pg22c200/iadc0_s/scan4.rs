...
pub struct R(crate::R<SCAN4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCAN4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCAN4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCAN4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCAN4` writer"]
pub struct W(crate::W<SCAN4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCAN4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCAN4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCAN4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PINNEG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCAN4_SPEC, u8, u8, 4, O>;
...
pub type PORTNEG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCAN4_SPEC, u8, PORTNEG_A, 4, O>;
...
pub type PINPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCAN4_SPEC, u8, u8, 4, O>;
...
pub type PORTPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCAN4_SPEC, u8, PORTPOS_A, 4, O>;
...
pub type CFG_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCAN4_SPEC, CFG_A, O>;
...
pub type CMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCAN4_SPEC, bool, O>;
impl R {
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [scan4](index.html) module"]
pub struct SCAN4_SPEC;
impl crate::RegisterSpec for SCAN4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [scan4::R](R) reader structure"]
impl crate::Readable for SCAN4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [scan4::W](W) writer structure"]
impl crate::Writable for SCAN4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SCAN4 to value 0"]
impl crate::Resettable for SCAN4_SPEC {
