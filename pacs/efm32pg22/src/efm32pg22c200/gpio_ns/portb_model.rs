...
pub struct R(crate::R<PORTB_MODEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PORTB_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PORTB_MODEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PORTB_MODEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PORTB_MODEL` writer"]
pub struct W(crate::W<PORTB_MODEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PORTB_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PORTB_MODEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PORTB_MODEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MODE0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PORTB_MODEL_SPEC, u8, MODE0_A, 4, O>;
...
pub type MODE1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PORTB_MODEL_SPEC, u8, MODE1_A, 4, O>;
...
pub type MODE2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PORTB_MODEL_SPEC, u8, MODE2_A, 4, O>;
...
pub type MODE3_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PORTB_MODEL_SPEC, u8, MODE3_A, 4, O>;
...
pub type MODE4_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PORTB_MODEL_SPEC, u8, MODE4_A, 4, O>;
...
pub struct PORTB_MODEL_SPEC;
impl crate::RegisterSpec for PORTB_MODEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [portb_model::R](R) reader structure"]
impl crate::Readable for PORTB_MODEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [portb_model::W](W) writer structure"]
impl crate::Writable for PORTB_MODEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PORTB_MODEL to value 0"]
impl crate::Resettable for PORTB_MODEL_SPEC {
