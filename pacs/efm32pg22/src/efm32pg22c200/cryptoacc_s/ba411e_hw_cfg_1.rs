...
pub type G_AES_MODES_POSS_R = crate::FieldReader<u16, u16>;
...
pub type G_USE_MASKING_R = crate::BitReader<bool>;
...
impl R {
    ...
    #[inline(always)]
    pub fn g_aes_modes_poss(&self) -> G_AES_MODES_POSS_R {
        G_AES_MODES_POSS_R::new((self.bits & 0x01ff) as u16)
    }
    ...
    #[inline(always)]
    pub fn g_use_masking(&self) -> G_USE_MASKING_R {
        G_USE_MASKING_R::new(((self.bits >> 17) & 1) != 0)
    }
...
impl crate::Resettable for BA411E_HW_CFG_1_SPEC {
    const RESET_VALUE: Self::Ux = 0x0700_017f;
}
